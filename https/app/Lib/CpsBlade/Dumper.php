...
class Dumper
{
    public function dump($value, $checkEmpty = false, $option = [])
    {
        ...
        $dumper->setStyles([
            'default' => 'background-color:#fff; color:#222; line-height:1.2em; font-weight:normal; 
            font:12px Monaco, Consolas, monospace; word-wrap: break-word; white-space: pre-wrap; 
            position:relative; z-index:100000; margin:0px; display:table; ',
        ]);
        ...
        $style = $option['style'] ?? '';
        return "<div tp-ignore='1' style='display:inline-block;$style'>"
        . $dumper->dump(
